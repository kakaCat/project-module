...
public interface TimeInventoryLockService {
     ...
     * @return
     */
    List<TimeInventoryLockModel> getTimeInventoryLocksByLockScope( Integer lockScope,String lockScopeId,Integer state);
     ...
     * @return
     */
    int countTimeInventoryLocksByLockScope( int lockScope,  String lockScopeId);
     ...
     * @return
     */
    List<TimeInventoryLockModel> getTimeInventoryLocksByScopeAndDates(Integer scope, String scopeId,Integer state,Date startDate,Date endDate);
